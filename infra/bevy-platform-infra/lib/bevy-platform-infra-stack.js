...
class BevyPlatformInfraStack extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        // アーティファクト用のS3バケットを作成
        const { accessLogBucket: artifactAccessLogBucket, artifactBucket, } = (0, s3_buckets_1.createPrimaryArtifactBuckets)(this, envName, this.account);
